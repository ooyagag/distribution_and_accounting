...
import { initialValuesProducts } from "../../initialsValues";
import { ProductSchema } from "../../rules/productsRules";
...
export function FormProduct({open, handleClose, refresh, setrefresh} : any)
{
    ...
    const onSubmit = async (values: initialFValuesTypes, formikHelpers: FormikHelpers<any>) => {
        ...
        try {
            ...
            const res = await ProductsRequest.product({
